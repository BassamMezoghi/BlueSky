$PBExportHeader$w_search_casher.srw
forward
global type w_search_casher from w_response
end type
type pb_1 from picturebutton within w_search_casher
end type
type dw_2 from u_dw within w_search_casher
end type
type dw_1 from u_dw within w_search_casher
end type
end forward
...
global w_search_casher w_search_casher

type variables
Long il_res = -1
end variables

on w_search_casher.create
int iCurrent
call super::create
...
integer height = 1232
integer taborder = 20
string dataobject = "d_search_casher"
