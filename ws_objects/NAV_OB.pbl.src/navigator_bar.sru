$PBExportHeader$navigator_bar.sru
forward
global type navigator_bar from userobject
end type
type cb_refresh from commandbutton within navigator_bar
end type
type cb_next from commandbutton within navigator_bar
end type
type cb_last from commandbutton within navigator_bar
end type
type cb_pre from commandbutton within navigator_bar
end type
type cb_first from commandbutton within navigator_bar
end type
end forward
...
global navigator_bar navigator_bar
...
idw_nav.event dynamic retrieverow( idw_nav.GetRow() )
