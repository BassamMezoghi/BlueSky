$PBExportHeader$uo_small_select_dt_neo.sru
forward
global type uo_small_select_dt_neo from userobject
end type
type st_2 from statictext within uo_small_select_dt_neo
end type
type st_1 from statictext within uo_small_select_dt_neo
end type
type dp_2 from datepicker within uo_small_select_dt_neo
end type
type dp_1 from datepicker within uo_small_select_dt_neo
end type
end forward
...
global uo_small_select_dt_neo uo_small_select_dt_neo
...
on uo_small_select_dt_neo.create
...
on uo_small_select_dt_neo.destroy
destroy(this.st_2)
destroy(this.st_1)
destroy(this.dp_2)
destroy(this.dp_1)
...
datetime value = DateTime(Date("2018-04-01"), Time("16:02:06.000000"))
integer textsize = -10
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
