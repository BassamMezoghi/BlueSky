...
global n_cst_user32 n_cst_user32
...
function ulong FindWindowEx( ulong hwndParent, ulong hwndChildAfter, ref string lpszClass, ref string lpszWindow) Library "USER32.DLL" Alias for "FindWindowExA;Ansi"
...
Function Boolean TrackPopupMenu(ulong hMenu,uint uFlags, int x, int y, int nReserved, ulong hWnd, ref tagrect rect) Library "USER32.DLL" alias for "TrackPopupMenu;Ansi"
Function Boolean TrackPopupMenuEx(ulong hMenu,uint fuFlags, int x, int y, ulong hWnd, ref tagtpmparams lptpm) Library "USER32.DLL" alias for "TrackPopupMenuEx;Ansi"
Function ulong LoadMenu(ulong hInstance, ref string lpMenuName) Library "USER32.DLL" Alias for "LoadMenuA;Ansi"
Function ulong CreatePopupMenu() Library "USER32.DLL"
Function long EnumProps(ulong hWnd, ulong lpEnumFunc) Library "USER32.DLL" Alias for "EnumPropsA"
Function ulong GetProp(ulong hWnd, ref string lpString) Library "USER32.DLL" Alias for "GetPropA;Ansi"
Function ulong SetWindowsHookEx(long idHook,ulong lpfn,ulong hMod,ulong dwThreadId) Library "USER32.DLL" Alias for "SetWindowsHookExA"
...
//
CONSTANT uint TPM_LEFTALIGN 		= 0
CONSTANT uint TPM_CENTERALIGN 	= 4
CONSTANT uint TPM_RIGHTALIGN 		= 8

CONSTANT uint TPM_TOPALIGN 		= 0
CONSTANT uint TPM_VCENTERALIGN	= 16
CONSTANT uint TPM_BOTTOMALIGN 	= 32

CONSTANT uint TPM_HORIZONTAL 		= 0
CONSTANT uint TPM_VERTICAL 		= 64

CONSTANT uint TPM_NONOTIFY 		= 128
CONSTANT uint TPM_RETURNCMD 		= 256

CONSTANT uint TPM_LEFTBUTTON 		= 0
CONSTANT uint TPM_RIGHTBUTTON 	= 2
